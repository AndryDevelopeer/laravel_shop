...
// Exports
            ...
            var defaultOptions = {
                ...
                /**
                 * The same as `inputId`. If both are null, images will not be resized.
                 */
                inputId: '',

                /**
                 * The same as `file_list`. If both are null, images will not be resized.
                 */
                files: [],

                /**
                 * The same as `dataTransfer`. If both are null, images will not be resized.
                 */
                dataTransfer: null,
   ...
   */
                ...
                thumbnail: function thumbnail(file, dataUrl) {
                    const multiInput = document.getElementById(this.options.inputId)
                    if (this.options.dataTransfer === null) {
                        this.options.dataTransfer = new DataTransfer();
                    }
                    this.options.dataTransfer.items.add(file)
                    this.options.files.push(file)

                    multiInput.files = this.options.dataTransfer.files;
